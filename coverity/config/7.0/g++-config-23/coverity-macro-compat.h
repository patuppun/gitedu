...
#endif
#if !(defined(__USING_SJLJ_EXCEPTIONS__) || defined(__coverity_undefine___USING_SJLJ_EXCEPTIONS__))
...
#endif
#if !(defined(__USES_INITFINI__) || defined(__coverity_undefine___USES_INITFINI__))
...
#define __STDC__ 1
#endif
#if !(defined(__ARM_ARCH_4T__) || defined(__coverity_undefine___ARM_ARCH_4T__))
