...
#endif
#if !(defined(__LANGUAGE_C) || defined(__coverity_undefine___LANGUAGE_C))
...
#endif
#if !(defined(__LANGUAGE_C__) || defined(__coverity_undefine___LANGUAGE_C__))
...
#endif
#if !(defined(LANGUAGE_C) || defined(__coverity_undefine_LANGUAGE_C))
#define LANGUAGE_C 1
#endif
...
#endif
#if !(defined(_LANGUAGE_C) || defined(__coverity_undefine__LANGUAGE_C))
